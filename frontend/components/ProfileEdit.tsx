...
const [showFarcasterOptions, setShowFarcasterOptions] = useState(false);
    ...
    try {
        ...
        showNotification('Failed to check Farcaster. Please try again.', 'error');
    } finally {
...
const handleVerifyFarcaster = async (usePhoto: boolean) => {
    try {
        ...
        showNotification('Failed to verify Farcaster. Please try again.', 'error');
    }
};
    ...
    <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
        ...
        {!showFarcasterOptions ? (
            ...
            <div className="space-y-3">
                {farcasterProfile && (
                    <div className="bg-white rounded-lg p-3 border border-purple-200">
                        ...
                        <div className="space-y-2">
                            <button
                                type="button"
                                onClick={() => handleVerifyFarcaster(false)}
                            ...
                            <button
                                type="button"
                                onClick={() => handleVerifyFarcaster(true)}
                ...
                <button
                    type="button"
                    onClick={() => setShowFarcasterOptions(false)}
