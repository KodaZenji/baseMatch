...
export default function FarcasterVerificationSection({
    ...
    if (farcasterVerified) {
        return (
            <div className="bg-purple-50 dark:bg-purple-50 border border-purple-200 dark:border-purple-300 rounded-xl p-4">
    ...
    return (
        <div className="bg-purple-50 dark:bg-purple-80 border border-purple-200 dark:border-purple-200 rounded-xl p-4">
