      ...
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center p-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-gray-400 text-sm mb-6">
            We'll review your collab request and get back to you via Discord within 2-3 days.
          </p>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-extrabold text-white mb-3" style={{ fontFamily: "'Syne', sans-serif" }}>
            Partner{' '}
            <span className="bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">with Us</span>
          </h1>
          <p className="text-gray-400 text-sm leading-relaxed">
            Apply to collaborate with BaseMatch Genesis. Approved partners receive BMG whitelist spots to raffle to their community. We'll review and respond within 2-3 days.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-white/8 bg-white/4 p-6 space-y-4">
            <h2 className="text-white font-bold text-base">BMG Spots Requested</h2>
            <div>
              <label className={labelCls}>What are you requesting? *</label>
              <textarea className={inputCls} rows={2} placeholder="e.g. Requesting 5x BMG whitelist spots for our community"
                value={form.prize_description} onChange={e => setForm(p => ({ ...p, prize_description: e.target.value }))} />
            </div>
            <div>
              <label className={labelCls}>Number of Spots *</label>
          ...
          <button onClick={handleSubmit} disabled={submitting}
            ...
            {submitting ? 'Submitting...' : 'Submit Collab Request →'}
          </button>

          <p className="text-center text-gray-600 text-xs">
            We review all partner applications within 2-3 days. You'll be contacted via Discord.
          </p>
        </div>
      </div>
    </div>
